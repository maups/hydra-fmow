...
directories = {}
directories['dataset'] = '/data'
directories['input'] = os.path.join('/wdata', 'input')
directories['output'] = os.path.join('/wdata', 'output')
directories['working'] = os.path.join('/wdata', 'working')
...
files = {}
files['training_struct1'] = os.path.join(directories['working'], 'training_struct1.json')
files['test_struct1'] = os.path.join(directories['working'], 'test_struct1.json')
files['dataset_stats1'] = os.path.join(directories['working'], 'dataset_stats1.json')

files['training_struct2'] = os.path.join(directories['working'], 'training_struct2.json')
files['test_struct2'] = os.path.join(directories['working'], 'test_struct2.json')
files['dataset_stats2'] = os.path.join(directories['working'], 'dataset_stats2.json')

files['training_struct3'] = os.path.join(directories['working'], 'training_struct3.json')
files['test_struct3'] = os.path.join(directories['working'], 'test_struct3.json')
files['dataset_stats3'] = os.path.join(directories['working'], 'dataset_stats3.json')
